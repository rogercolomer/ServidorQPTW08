...
driver.get("http://x.x.x.x:3000/d/kWrTyjoGz/compressors?orgId=1&refresh=1m")
...
WebDriverWait(driver, 20).until(EC.element_to_be_clickable(EMAIL_FIELD)).send_keys('xxxxx')
time.sleep(1)
pyautogui.press('tab')
time.sleep(1)
pyautogui.press('x')
