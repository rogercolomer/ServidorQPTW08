...
WebDriverWait(driver, 20).until(EC.element_to_be_clickable(userBiomas)).send_keys('xx')
WebDriverWait(driver, 20).until(EC.element_to_be_clickable(pwdBiomas)).send_keys('xx!')
...
WebDriverWait(driver, 20).until(EC.element_to_be_clickable(useGrafana)).send_keys('xxx')
WebDriverWait(driver, 20).until(EC.element_to_be_clickable(pwdGrafana)).send_keys('xx')
