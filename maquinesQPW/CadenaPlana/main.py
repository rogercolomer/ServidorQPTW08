...
# from sqliteIOT import *
from machineIOT import UART
from mariadbIOT import mariaIOT
from mesbookIOT import mesbookIOT
...
class Fisico:
    ...
    def lecturaDada(self):
        ...
        if sMach == 1:
            ...
            elif self.registre.dataA[2] == 8:
                self.registreEstat = 2
            else:
                self.registreEstat = 1
            # elif estat == 8: registre estat == 3
            return True
        else:
            return False
