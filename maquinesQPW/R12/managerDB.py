...
class mesbookDB():
    ...
    def orderFisico(self, data):
        ...
        if data:
            for d in data:
                ...
                variables['Tramo'] = 1
                variables['NumeroRegistro'] = int(d[0])
                variables['FechaHora'] = str(d[1])
                variables['EstadoLinea'] = int(d[2])
                variables['Linea'] = int(d[3])
                variables['Procesadas'] = int(d[4])
                variables['Buenas'] = int(d[5])
    ...
    def orderParada(self, data):
        ...
        if data:
            ...
            for d in data:
                variables['NumeroRegistro'] = int(d[0])
                variables['FechaHoraInicio'] = str(d[1])
                variables['FechaHoraFin'] = str(d[2])
                variables['Linea'] = int(d[3])
                variables['MarchaMaquina'] = int(d[4])
